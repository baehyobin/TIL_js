...
const slideWarp = document.getElementsByClassName('slide_wrap')
console.log(slide);
slide[0].style.backgroundColor='#ff0'
slide[1].style.backgroundColor='rgba(0,0,0,0.1)'
slideWarp[0].style.border='5px solid orange'
...
console.log(navMain,navGnb,navLi,navLi_v2,navA) 
...
//DOM 변수 사용시 ALL 키워드 유무에 따라 [인덱스] 사용 주의하기
